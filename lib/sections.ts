  ...
  switch (ct.archetype) {
    ...
    case "collateral":
      ...
      return {
        ...
        steps: [
          ...SPINE,
          { id: "concept", label: "Layout concept" },
          { id: "style", label: "Style guide" },
          { id: "details", label: "Content & notes" },
          { id: "specs", label: "Sizes & location" },
          REVIEW,
        ],
        conceptLabel: "Layout concept",
        conceptHint:
          "The look, hierarchy, and feel of the piece. Usually executes an existing key visual.",
        palette: true,
        typography: true,
        sourceAssets: true,
        mood: true,
    ...
    case "ad":
      ...
      return {
        ...
        conceptHint: "The hook and visual idea — what stops the scroll.",
        keyMessagesLabel: "Key messages",
        keyMessagesHint:
    ...
    case "social":
      ...
      if (ct.id === POST)
        return {
          ...
          conceptHint: "The concept, theme, and what this single post is trying to achieve.",
          designerNotes: true,
      ...
      if (ct.id === STORY)
        return {
          ...
          steps: [
            { id: "basics", label: "Project basics" },
            { id: "objective", label: "Objective" },
            { id: "concept", label: "Creative direction" },
            { id: "slides", label: "Frames" },
            { id: "details", label: "Design notes" },
            { id: "specs", label: "Specs & location" },
            REVIEW,
          ],
          conceptLabel: "Creative direction",
          conceptHint: "The concept and tone. Stories are always 1080×1920px.",
          designerNotes: true,
      ...
      return {
        ...
        conceptLabel: "Creative direction",
        conceptHint: "The concept and tone for this carousel — what it's about and how it should feel.",
        designerNotes: true,
        designerNotesLabel: "Design notes (incl. layout option)",
        sizes: true,
      };
